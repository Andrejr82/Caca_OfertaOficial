...
export function copyV5FactsFromOffer(offer: OfficialAIOffer): CopyV5Facts {
  ...
  const freeShipping = [
    ...
    (explainabilityMetrics as Record<string, unknown> | undefined)?.free_shipping,
    (explainabilityMetrics as Record<string, unknown> | undefined)?.shipping_free,
    (explainabilityMetrics as Record<string, unknown> | undefined)?.shippingFree,
