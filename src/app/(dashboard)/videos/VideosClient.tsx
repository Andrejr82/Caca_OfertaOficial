...
import { CheckCircle2, Clock3, Download, Film, Loader2, Play, RefreshCw, Send, Sparkles, XCircle } from "lucide-react";
...
export function VideosClient({ offers, initialJobs }: { offers: Offer[]; initialJobs: Job[] }) {
  ...
  async function regenerate(id: string) {
    if (!window.confirm("Gerar outra versão adicionará um novo job à fila. Deseja continuar?")) return;
