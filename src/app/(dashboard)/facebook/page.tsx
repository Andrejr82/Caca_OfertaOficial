    ...
    <div className="grid gap-6 animate-fadeIn">
      <header className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-white/35">Posts estáticos e histórico. Vídeos aprovados são distribuídos pela aba Reels.</p>
        </div>
      </header>

      {!hasFacebookEnv() && (
        <div className="rounded-lg border border-amber-400/30 bg-amber-400/10 p-4 text-sm text-amber-100">
          Configure FACEBOOK_PAGE_ID e FACEBOOK_ACCESS_TOKEN para publicar na Página.
        </div>
      )}

      <SocialChannelPostsView
        channel="facebook"
        accentClassName="bg-blue-500/15 text-blue-300"
