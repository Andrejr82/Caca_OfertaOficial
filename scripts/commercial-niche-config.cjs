  ...
  informatica: Object.freeze({
    ...
    guardrails: Object.freeze({
      ...
      blockedProductTerms: Object.freeze([
        ...
        'suporte para ssd', 'suporte de ssd', 'adaptador para ssd', 'adaptador de ssd',
        'peca de reposicao', 'peca para impressora', 'reparo para impressora',
        'smartwatch', 'smart watch', 'monitor de pressao',
      ]),
    }),
  }),
