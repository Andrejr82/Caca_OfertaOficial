...
const ALLOWED_MARKETPLACES = Object.freeze(['Shopee', 'Mercado Livre', 'Amazon']);
...
const INTENT_CONFIG = Object.freeze(Object.fromEntries(Object.entries({
  ...
  eletro_validado_para_casa: { range: [45, 2800], positive: /air fryer|liquidificador|cafeteira|aspirador|geladeira|refrigerador|lavadora|lava e seca|lava-lou[cç]as|ventilador|micro-ondas|fog[aã]o|cooktop|ar condicionado/i, risk: /pe[cç]a de reposi[cç][aã]o|resistencia avulsa|placa avulsa|mangueira avulsa|motor avulso|refil avulso|capa protetora/i, preferred: 'mercadolivre', mode: 'automatic', required: ['price', 'affiliateUrl', 'imageUrl'], hook: 'Eletro em promoção para facilitar a rotina da casa' },
