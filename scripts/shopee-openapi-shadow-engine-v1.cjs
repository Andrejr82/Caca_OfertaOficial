...
const SCENARIO_CONTRACTS = Object.freeze({
  ...
  celulares_editorial: scenario(['celular','smartphone','iphone','galaxy','redmi','mobile'], ['smartphone','celular','iphone','galaxy','redmi','carregador','power bank','capa celular'], ['notebook','monitor','cabo avulso','pelicula avulsa'], ['capa sem compatibilidade'], [100013]),
  ...
  games_editorial: scenario(['game','gamer','console','playstation','xbox','nintendo'], ['console','playstation','xbox','nintendo','controle','jogo','cadeira gamer','headset gamer'], ['pet','bebe','software ilegal','conta digital'], ['cadeira sem contexto gamer'], [100634]),
  ...
  grandes_ofertas_editorial: scenario(['oferta','desconto','promocao','smartphone','notebook','tablet','smart tv','soundbar','air fryer','liquidificador','cafeteira','aspirador','geladeira','fogao','cooktop','maquina de lavar','furadeira','parafusadeira','cadeira de escritorio','sofa','armario'], ['smartphone','celular','notebook','tablet','smart tv','soundbar','air fryer','liquidificador','cafeteira','aspirador','geladeira','fogao','cooktop','maquina de lavar','furadeira','parafusadeira','cadeira de escritorio','sofa','armario'], ['usado','recondicionado','servico','cupom sem aprovacao'], [], [100013,100010,100644,100636], { negativeClasses: ['spare_part','replacement_part','generic_accessory','weak_accessory','compatibility_only','small_school_item'], minDiscount: 20, minSales: 50, minRating: 4.7, minCommission: 5, maxFamilyPerScenario: 30, maxShopPerScenario: 8 }),
});
...
const SCENARIO_QUERY_PLANS = Object.freeze({
  ...
  celulares_editorial: queryPlan(['carregador turbo','capinha celular','fone bluetooth','power bank','suporte celular'], [100013]),
  ...
  games_editorial: queryPlan(['console','controle gamer','jogo ps5','cadeira gamer','headset gamer'], [100634]),
  ...
  grandes_ofertas_editorial: queryPlan(['smartphone oferta','notebook oferta','smart tv promoção','air fryer desconto','geladeira promoção','máquina de lavar oferta','furadeira promoção','aspirador robô','cadeira escritório'], [100013,100010,100644,100636]),
});
