...
const SEARCH_ALIASES = {
  ...
  'camiseta feminina': ['camiseta feminina', 'camiseta mulher', 'blusa feminina básica'],
  'vestido feminino': ['vestido feminino', 'vestido casual feminino', 'vestido midi feminino'],
  'calça jeans masculina': ['calça jeans masculina', 'calça jeans homem', 'calça masculina jeans'],
  'calça jeans feminina': ['calça jeans feminina', 'calça jeans mulher', 'calça feminina jeans'],
  'jaqueta masculina': ['jaqueta masculina', 'jaqueta homem', 'jaqueta casual masculina'],
  'mochila escolar': ['mochila escolar', 'mochila estudante', 'mochila para escola'],
  'sapato masculino': ['sapato masculino', 'sapato social masculino', 'mocassim masculino'],
  'sandália feminina': ['sandália feminina', 'sandalia mulher', 'sandália casual feminina'],
  'bota feminina': ['bota feminina', 'bota mulher', 'bota casual feminina'],
  'pijama feminino': ['pijama feminino', 'pijama mulher', 'pijama feminino algodão'],
  'cinto masculino': ['cinto masculino', 'cinto homem', 'cinto social masculino'],
  'bolsa transversal': ['bolsa transversal', 'bolsa tiracolo feminina', 'bolsa transversal feminina'],
  'roupa fitness feminina': ['roupa fitness feminina', 'conjunto academia feminino', 'moda fitness feminina'],
