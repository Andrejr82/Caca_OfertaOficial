...
const EDITORIAL_SCENARIO_CATALOG = Object.freeze({
  casa_cozinha_editorial: scenario('casa_cozinha_editorial', 'Casa e Cozinha', 7,
    ['jogo de cama casal', 'lençol percal', 'kit travesseiro', 'edredom casal', 'cobre leito casal', 'jogo de toalhas banhão', 'toalha de banho', 'porta shampoo banheiro', 'dispenser sabonete', 'tapete banheiro', 'lixeira para banheiro', 'jogo de panelas antiaderente', 'conjunto de panelas cerâmica', 'jogo de potes herméticos', 'potes de vidro com trava', 'faqueiro', 'aparelho de jantar', 'escorredor de louça', 'porta temperos', 'kit utensílios de silicone', 'tábua de corte bambu'],
    ['jogo de cama', 'lençol', 'travesseiro', 'edredom', 'cobre leito', 'toalha de banho', 'jogo de toalhas', 'porta shampoo', 'dispenser sabonete', 'tapete banheiro', 'lixeira banheiro', 'jogo de panelas', 'conjunto de panelas', 'potes hermeticos', 'potes de vidro', 'faqueiro', 'talheres', 'aparelho de jantar', 'escorredor de louca', 'porta temperos', 'utensilios de silicone', 'tabua de corte'],
    [],
    ['size', 'material', 'pieces', 'color', 'capacity'], { apiCategories: [100010, 100636, 100710, 100717, 100718], amazonBrowseNodes: ['17100532011', '17100553011', '17100533011', '17100522011'], priceRange: { min: 18, targetMax: 220, hardMax: 600 } }),
  ...
  organizacao_editorial: scenario('organizacao_editorial', 'Organização', 8,
    ...
    ['material', 'dimensions', 'quantity', 'capacity'], { apiCategories: [100010, 100636], amazonBrowseNodes: ['17100533011', '17100522011', '17124717011'], priceRange: { min: 15, targetMax: 180, hardMax: 500 } }),
  ...
  ferramentas_editorial: scenario('ferramentas_editorial', 'Ferramentas', 15,
    ...
    ['brand', 'model', 'voltage', 'power', 'pieces'], { apiCategories: [100636], amazonBrowseNodes: ['165793011', '165796011'], priceRange: { min: 25, targetMax: 450, hardMax: 1500 } }),
  ...
  informatica_editorial: scenario('informatica_editorial', 'Informática', 11,
    ...
    ['brand', 'model', 'memory', 'screen', 'connectivity'], { apiCategories: [100644, 100013], amazonBrowseNodes: ['16243803011', '16243794011', '24035344011'], priceRange: { min: 40, targetMax: 2800, hardMax: 5000 } }),
  ...
  celulares_editorial: scenario('celulares_editorial', 'Celulares', 11,
    ...
    ['brand', 'model', 'memory', 'screen', 'battery'], { apiCategories: [100013], amazonBrowseNodes: ['16243809011', '16243799011'], priceRange: { min: 400, targetMax: 2800, hardMax: 6000 } }),
  ...
  beleza_editorial: scenario('beleza_editorial', 'Beleza', 9,
    ...
    ['brand', 'volume', 'function', 'skin_type', 'fragrance'], { apiCategories: [100630, 100001], amazonBrowseNodes: ['16754345011', '16754346011', '16754347011'], priceRange: { min: 15, targetMax: 220, hardMax: 600 } }),
  ...
  moda_editorial: scenario('moda_editorial', 'Moda', 13,
    ...
    ['brand', 'size', 'color', 'material', 'gender'], { apiCategories: [100009, 100011, 100012, 100534], amazonBrowseNodes: ['17681970011', '17681966011', '23577004011'], priceRange: { min: 25, targetMax: 250, hardMax: 800 } }),
  ...
  esporte_editorial: scenario('esporte_editorial', 'Esporte', 14,
    ...
    ['brand', 'size', 'weight', 'material', 'volume'], { apiCategories: [100637, 100001], amazonBrowseNodes: ['17833921011', '17833929011', '17833917011'], priceRange: { min: 20, targetMax: 350, hardMax: 2000 } }),
  ...
  pet_editorial: scenario('pet_editorial', 'Pet', 17,
    ...
    ['species', 'size', 'weight', 'material', 'flavor'], { apiCategories: [100631], amazonBrowseNodes: ['19653951011', '19653950011', '19653948011'], priceRange: { min: 20, targetMax: 200, hardMax: 600 } }),
  ...
  tv_audio_editorial: scenario('tv_audio_editorial', 'TV e Áudio', 18,
    ...
    ['brand', 'screen', 'resolution', 'power', 'connectivity'], { apiCategories: [100013, 100644], amazonBrowseNodes: ['16243803011', '16243794011', '16243809011'], priceRange: { min: 50, targetMax: 2800, hardMax: 5000 } }),

  eletrodomesticos_editorial: scenario('eletrodomesticos_editorial', 'Eletrodomésticos', 19,
    ['air fryer', 'air fryer 4l', 'air fryer 5l', 'cafeteira eletrica', 'cafeteira expresso', 'liquidificador potente', 'panela de pressao eletrica', 'panela eletrica de arroz', 'mixer eletrico', 'batedeira planetaria', 'sanduicheira', 'grill eletrico', 'chaleira eletrica', 'aspirador vertical', 'robo aspirador', 'forno eletrico', 'geladeira frost free', 'refrigerador duplex', 'maquina de lavar', 'lava e seca', 'micro-ondas', 'cooktop', 'fogao', 'ar condicionado inverter', 'lava-loucas', 'frigobar', 'freezer'],
    ['air fryer', 'airfryer', 'fritadeira eletrica', 'cafeteira', 'liquidificador', 'panela eletrica', 'panela de pressao eletrica', 'mixer', 'batedeira', 'sanduicheira', 'grill', 'chaleira eletrica', 'aspirador vertical', 'robo aspirador', 'aspirador po', 'forno eletrico', 'geladeira', 'refrigerador', 'maquina de lavar', 'lavadora', 'lava e seca', 'micro-ondas', 'microondas', 'cooktop', 'fogao', 'ar condicionado', 'lava loucas', 'frigobar', 'freezer'],
    [],
    ['brand', 'model', 'capacity', 'dimensions', 'voltage', 'power'], { apiCategories: [100041, 100198, 100194, 100193, 100197, 100010], amazonBrowseNodes: ['17124786011', '16745371011', '16745366011'], priceRange: { min: 40, targetMax: 2800, hardMax: 4500 } }),
