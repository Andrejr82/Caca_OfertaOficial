...
const SHOPEE_PRODUCTCATIDS_MAP_V1 = Object.freeze({
  ...
  'Eletrodomésticos': Object.freeze({
    ...
    'air fryer': Object.freeze({
      decision: 'promover', confidence: 'alta',
      recommendedProductCatIdPath: Object.freeze(['100010', '100041', '100198']), rootProductCatId: 100010,
      reason: 'Produto final transferido ao nicho Eletrodomésticos.',
    }),
    'liquidificador': Object.freeze({
      decision: 'promover', confidence: 'alta',
      recommendedProductCatIdPath: Object.freeze(['100010', '100041', '100193']), rootProductCatId: 100010,
      reason: 'Produto final transferido ao nicho Eletrodomésticos.',
    }),
    'cafeteira': Object.freeze({
      decision: 'promover', confidence: 'alta',
      recommendedProductCatIdPath: Object.freeze(['100010', '100041', '100194']), rootProductCatId: 100010,
      reason: 'Produto final transferido ao nicho Eletrodomésticos.',
    }),
    'aspirador': Object.freeze({
      decision: 'promover', confidence: 'alta',
      recommendedProductCatIdPath: Object.freeze(['100010', '100038', '100177']), rootProductCatId: 100010,
      reason: 'Categoria folha de aspirador doméstico validada ao vivo.',
    }),
    'ferro de passar': Object.freeze({
      decision: 'promover', confidence: 'alta',
      recommendedProductCatIdPath: Object.freeze(['100010', '100038', '100175']), rootProductCatId: 100010,
      reason: 'Categoria folha de ferro e passadeira validada ao vivo.',
    }),
    'ventilador': Object.freeze({
      decision: 'promover', confidence: 'alta',
      recommendedProductCatIdPath: Object.freeze(['100010', '100039', '100181']), rootProductCatId: 100010,
      reason: 'Categoria folha de ventilador doméstico validada ao vivo.',
    }),
  }),
  ...
  'Ferramentas': Object.freeze({
    'furadeira': Object.freeze({
      ...
      reason: 'Máquina completa aprovada como produto final de Ferramentas.',
    }),
    ...
    'alicate': Object.freeze({
      ...
      recommendedProductCatIdPath: Object.freeze(['100636', '100715', '101191']),
      rootProductCatId: 100636,
      reason: 'Item manual avulso bloqueado; Ferramentas aceita máquinas completas e kits.',
    }),
    'chave': Object.freeze({
      decision: 'bloquear',
      confidence: 'media',
    ...
    'maleta de ferramentas': Object.freeze({
      ...
      recommendedProductCatIdPath: Object.freeze(['100636', '100715', '101191']),
      rootProductCatId: 100636,
      reason: 'Maleta vazia ou avulsa bloqueada; apenas kit completo é promovido.',
    }),
    'kit ferramentas': Object.freeze({
      ...
      recommendedProductCatIdPath: Object.freeze(['100636', '100715', '101191']),
      rootProductCatId: 100636,
      reason: 'Kit completo validado como produto final de Ferramentas.',
    }),
    'lixadeira': Object.freeze({
      decision: 'promover', confidence: 'alta',
      recommendedProductCatIdPath: Object.freeze(['100636', '100715', '101191']), rootProductCatId: 100636,
      reason: 'Máquina completa validada ao vivo; acessórios e uso em unhas permanecem bloqueados.',
    }),
  }),
  ...
  'Pet': Object.freeze({
    'ração cachorro': Object.freeze({
      ...
      reason: 'Categoria folha validada ao vivo com vendas, avaliação e comissão.',
    }),
    ...
    'tapete higiênico': Object.freeze({
      ...
      rootProductCatId: 100631,
      reason: 'Produto final de higiene Pet validado na categoria folha.',
    }),
    ...
    'brinquedo pet': Object.freeze({
      ...
      rootProductCatId: 100631,
      reason: 'Produto final Pet validado na categoria folha.',
    }),
    'coleira': Object.freeze({
      ...
      rootProductCatId: 100631,
      reason: 'Acessório de passeio excluído por decisão editorial.',
    }),
...
const FAMILY_SEMANTIC_DICTIONARY = Object.freeze({
  ...
  'toalha': Object.freeze({ keyword: 'toalha de banho', terms: Object.freeze(['toalha de banho', 'toalha banho', 'toalhao', 'roupao']) }),
  ...
  'aspirador': Object.freeze({ keyword: 'aspirador', terms: Object.freeze(['aspirador de po', 'aspirador robo', 'robo aspirador']) }),
  'ferro de passar': Object.freeze({ keyword: 'ferro de passar', terms: Object.freeze(['ferro de passar', 'passadeira a vapor', 'vaporizador de roupas']) }),
  'ventilador': Object.freeze({ keyword: 'ventilador', terms: Object.freeze(['ventilador']) }),
  ...
  'lixadeira': Object.freeze({ keyword: 'lixadeira', terms: Object.freeze(['lixadeira', 'esmerilhadeira']) }),
