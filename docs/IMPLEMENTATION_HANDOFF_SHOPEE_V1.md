# IMPLEMENTATION HANDOFF â€” Motor Oficial de Busca e Ranking Shopee V1
...
[Categoria / intencao]
  ...
  -> Filtros comerciais (eliminatorios configurÃ¡veis)
...
| Filtros comerciais | Limites eliminatorios configurÃ¡veis |
...
| src/lib/shopee/ranking/commercial-filters.ts | Filtros eliminatorios configurÃ¡veis |
...
- Filtros minimos configurÃ¡veis e versionados
