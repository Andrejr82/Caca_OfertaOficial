-- MIGRATION: ADICIONAR PLATAFORMA NETSHOES NA TABELA DE OFERTAS
...
-- 2. Adicionar a nova constraint atualizada que inclui a Netshoes
ALTER TABLE public.offers ADD CONSTRAINT offers_platform_check 
  CHECK (platform IN ('Shopee', 'Amazon', 'Magalu', 'Mercado Livre', 'Shein', 'Netshoes', 'Outro', 'Link Externo'));
